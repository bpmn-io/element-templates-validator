...
import schema from '@camunda/zeebe-element-templates-json-schema/resources/schema.json' with { type: 'json' };
import errorMessages from '@camunda/zeebe-element-templates-json-schema/resources/error-messages.json' with { type: 'json' };
